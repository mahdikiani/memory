...
from apps.knowledge.schemas import KnowledgeChunk
from apps.knowledge.services.embedding_service import EmbeddingService
from apps.knowledge.utils.query_executor import execute_query, execute_vector_query
...
class VectorRetriever(BaseRetriever):
    ...
    async def _fallback_vector_search(self, query: str) -> list[Document]:
        """Fallback to manual cosine similarity with safe queries."""
        ...
        try:
            ...
            query_builder = (
                ...
                .limit(self.limit * 2)  # Get more for manual filtering
            )
            ...
            chunks_with_scores = chunks_with_scores[: self.limit]
