...
async def execute_exact_match_query(
    ...
    from apps.knowledge.utils.query_builder_orm import QueryBuilder
...
async def execute_fulltext_query(
    ...
    """
    from apps.knowledge.utils.query_builder_orm import FullTextQueryBuilder
...
async def execute_vector_query(
    ...
    """
    from apps.knowledge.utils.query_builder_orm import VectorQueryBuilder
