"""Exceptions for the memory service."""
...
class BaseHTTPException(HTTPException):
    """Base HTTP exception for the memory service."""
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        """Initialize the base HTTP exception."""
...
def pydantic_exception_handler(request: Request, exc: ValidationError) -> JSONResponse:
...
# A dictionary for dynamic registration of exception handlers
EXCEPTION_HANDLERS = {
