...
class KnowledgeSource(BaseSurrealTenantEntity):
...
class KnowledgeChunk(BaseSurrealTenantEntity):
...
class Entity(BaseSurrealTenantEntity):
    ...
    confidence_level: str = Field(
        ...
        description="Confidence level: 'user_confirmed' or 'auto_extracted'",
    )
